...
import { XhiresAmbulanceWlEditor } from '../xhires-ambulance-wl-editor';
...
describe('xhires-ambulance-wl-editor', () => {
  ...
  it('buttons shall be of different type', async () => {
    ...
    const page = await newSpecPage({
      components: [XhiresAmbulanceWlEditor],
      html: `<xhires-ambulance-wl-editor entry-id="test-entry" ambulance-id="test-ambulance" api-base="http://sample.test/api"></<pfx>-ambulance-wl-editor>`,
    });
